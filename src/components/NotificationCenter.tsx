...
export function NotificationCenter() {
  ...
  return <div className="drawer-backdrop nexus-notification-overlay" onClick={() => setOpen(false)}>
    <aside className="notification-drawer" onClick={(e) => e.stopPropagation()} data-motion-surface="notification">
      ...
      <div className="notification-list" data-motion="notification-list">
        <div className="notification-item" data-motion="notification-item"><span className="notification-icon tone-green"><CheckCircle2 size={16} /></span><div><strong>Nexus sincronizado</strong><p>Dados e progresso estão conectados ao seu perfil.</p></div></div>
